...
/*
  ...
  Aqui definiremos lo que ocurre cuando pulsamos cada tecla
  P1:
    - Tecla 2 para el cubo dentro de los modos, ya que lo que es definir que la tecla
        2 sea el cubo, ya estaba.
    - Para que coja el cubo, hay que incluirlo en glwidget.h
